...
public class TqController {
    ...
    public static String excute(String cityName){
        String url=//此处以返回json格式数据示例,所以format=2,以根据城市名称为例,cityName传入中文
                "http://v.juhe.cn/weather/index?cityname="+cityName+"&key=284e04648d4db97276bc646de717d3df";
    ...
    public static void main(String[] args) {
        System.out.println(GetTodayTemperatureByCity("正宁"));
    }
}
